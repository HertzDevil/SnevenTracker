/* 
  ...
  01/12/16 HertzDevil
    - Replaced Blip_Buf with Blip_Buffer (TODO)
*/
...
static void *Mixer = 0;		// // //
void MixSN76489(void *Mixer, int Time, int Level, int Right);		// // //

void SN76489_Init(void *m, int type)		// // //
{
  int i;
